...
public class AddressBook {
    ...
    private static final String COMMAND_LISTBYORDER_WORD = "listbyorder";
    private static final String COMMAND_LISTBYORDER_DESC = "Displays all persons as a list by the person's name in alphabetical order.";
    private static final String COMMAND_LISTBYORDER_EXAMPLE = COMMAND_LISTBYORDER_WORD;
    ...
    private static String executeCommand(String userInputString) {
        ...
        switch (commandType) {
            ...
            case COMMAND_LISTBYORDER_WORD:
                return executeListByOrderAllPersonsInAddressBook();
    ...
    /**
     * Displays all persons in the address book to the user; in alphabetical order based on the Name.
     *
     * @return feedback display message for the operation result
     */
    private static String executeListByOrderAllPersonsInAddressBook() {
        ArrayList<String[]> copiedListOfPpl = new ArrayList<>();
        copiedListOfPpl.addAll(getAllPersonsInAddressBook());
        copiedListOfPpl.sort(new Comparator<String[]>() {
            @Override
            public int compare(String[] o1, String[] o2) {
                return o1[0].compareToIgnoreCase(o2[0]);
            }
        });
        showToUser(copiedListOfPpl);
        return getMessageForPersonsDisplayedSummary(copiedListOfPpl);
    }
    ...
    private static String getUsageInfoForAllCommands() {
        return getUsageInfoForAddCommand() + LS
                ...
                + getUsageInfoForListByOrderCommand() + LS
     ...
     * Returns the string for showing 'view' command usage instruction
     */
    private static String getUsageInfoForListByOrderCommand() {
        return String.format(MESSAGE_COMMAND_HELP, COMMAND_LISTBYORDER_WORD, COMMAND_LISTBYORDER_DESC) + LS
                + String.format(MESSAGE_COMMAND_HELP_EXAMPLE, COMMAND_LISTBYORDER_EXAMPLE) + LS;
    }
